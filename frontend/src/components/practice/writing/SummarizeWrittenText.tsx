    ...
    <div className="practice-body">
      ...
      <div>
        ...
        <textarea
          ...
          disabled={submitted}
          className="w-full border border-gray-200 rounded-xl p-3 sm:p-4 text-[15px] sm:text-sm text-gray-800 resize-none min-h-[7rem] sm:h-28 focus:outline-none focus:border-brand-yellow transition-colors placeholder-gray-300 disabled:bg-gray-50"
          placeholder="Viết một câu tóm tắt..."
        />
        <div className="flex flex-col gap-2 sm:flex-row sm:justify-between sm:items-center mt-2">
          ...
          >
            {wordCount}/75 từ {wordCount > 75 ? "⚠️ Quá dài" : ""}
          </span>
